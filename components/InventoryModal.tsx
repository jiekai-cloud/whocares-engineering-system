                        ...
                        <div className="animate-in fade-in slide-in-from-bottom-2 duration-300 space-y-6">
                            ...
                            <div className="flex justify-center mb-6">
                                <div className="relative group cursor-pointer">
                                    ...
                                    />
                                    <div className={`w-32 h-32 rounded-3xl flex items-center justify-center border-2 border-dashed transition-all overflow-hidden ${formData.photoUrl ? 'border-transparent shadow-lg' : 'border-slate-200 bg-slate-50 hover:bg-slate-100 hover:border-blue-300'
                                        }`}>
                                        {formData.photoUrl ? (
                                            ...
                                            <div className="text-center text-slate-400 group-hover:text-blue-500 transition-colors">
                                                ...
                                                <span className="text-[10px] font-black uppercase tracking-widest">上傳照片</span>
                                            </div>
                                        )}
                                    </div>
                                    {formData.photoUrl && (
                                        <button
                                            ...
                                            className="absolute -top-2 -right-2 bg-white text-rose-500 p-1.5 rounded-full shadow-md z-20 hover:bg-rose-50 transition-colors"
                                        >
                                            <Trash2 size={14} />
                                        </button>
                                    )}
